...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Movieprint'),
            InlineKeyboardButton('🧩 Source', url='https://t.me/Movieprint')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://t.me/Movieprint'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Movieprint'),     
        ],
        [
            InlineKeyboardButton("🎞 How to Deploy", url='https://t.me/Movieprint'),
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
